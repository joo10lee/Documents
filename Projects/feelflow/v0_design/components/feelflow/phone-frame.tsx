export function PhoneFrame({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex items-center justify-center min-h-screen bg-[#D5D0C8] p-4">
      <div className="relative w-[390px] h-[844px] rounded-[50px] bg-[#1A1A2E] shadow-[0_20px_60px_rgba(0,0,0,0.3),0_0_0_1px_rgba(255,255,255,0.05)] p-[10px] overflow-hidden">
        ...
        <div
          ...
          style={{
            background: 'linear-gradient(180deg, #F5F2EC 0%, #EDE9E1 100%)',
          }}
        >
          {/* Status bar */}
          ...
          {/* App content */}
          <div className="relative z-[1] h-[calc(100%-32px)] overflow-y-auto overflow-x-hidden scrollbar-hide">
            {children}
          </div>
        </div>
      </div>
